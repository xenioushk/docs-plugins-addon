...
function copy_trigger(d){(new Clipboard("."+d)).on("success",function(d){d.trigger.blur();d.trigger.innerHTML='<span class="success-check">&#x2714;</span>';window.setTimeout(function(){d.trigger.innerHTML='<img class="clippy" src="assets/images/clippy.svg" alt="Copy to clipboard">'},1500);d.clearSelection()})}
$(function(){$(document).find("pre").each(function(){var d=generate_random_string(15),h=$(this);h.attr("id",d);h.before('<span class="clip-btn-container text-right d-none"><button class="btn-copy btn-gradient btn '+d+'" data-clipboard-target="#'+d+'" data-unique-class="'+d+'" aria-label="Copy"><img src="assets/images/clippy.svg" class="clippy" aria-hidden="true"></button></span>')});setTimeout(function(){$(".clip-btn-container").removeClass("d-none")},2E3);$(document).find(".clip-btn-container .btn-copy").on("click",
